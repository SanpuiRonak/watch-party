...
const roomManager_1 = require("./src/lib/services/roomManager");
...
app.prepare().then(() => {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('video-event', async (roomId, eventType, currentTime, userId, playbackRate) => {
            try {
        ...
        socket.on('permissions-update', async (roomId, permissions) => {
            try {
