export const MESSAGES = {
  ...
  // Empty States
  noRoomsCreated: "Looks like you have not created any rooms yet. Please use Create Room to create a new room!",
  noRecentRooms: "Looks like you haven't joined any rooms recently. Ask your friends for the room link to join their rooms!",
} as const;
